...
const followersArray = ['torien3x', 'tetondan', 'dustinmyers', 'justsml', 'luissml', 'bigknell'];
...
function githubCard(gitInfo) {
  ...
  const profile = document.createAttribute('p');
  ...
  folowing.textContent = `Following: ${gitInfo.following}`;
